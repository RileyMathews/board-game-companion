module ButtonBase
  ...
  def color_classes
    ...
    when :danger
      "text-white bg-red-700 hover:bg-red-800 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" # rubocop:disable Layout/LineLength
    end
  end
end
